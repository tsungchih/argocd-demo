...
echo "INFO: Argocd will be uninstalled from argocd namespace."
echo -n "Do you want to proceed? [y/n]: "
read ans
if [ "$ans" == "y" ]; then
  kustomize build ${ENVDIR} | kubectl delete -f -
  kubectl delete -f ${BASEDIR}/argocd-${VER}-namespace-install.yaml
else
